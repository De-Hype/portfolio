    ...
    <section className="pt-3 about" id="about">
      ...
      <aside className="flex flex-col gap-1">
        <article className=" text-sm">
          ...
          Express.js, Typescript, and good ol&apos; Javascript.
        </article>
        <article className=" text-sm">
          With a keen eye for clean code, and a knack for creating interactive interfaces,
        ...
        <article className=" text-sm">
          ...
          collaborating, and bringing out outstanding web projects to life.
          If you have an exciting project or just want to chat about the latest in
